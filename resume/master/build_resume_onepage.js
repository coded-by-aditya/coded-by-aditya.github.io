...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      new Paragraph({
        ...
        children: [
          ...
          new ExternalHyperlink({
            link: "http://linkedin.com/in/aditya-mehrotra-mit",
            children: [new TextRun({ text: "LinkedIn", style: "Hyperlink", font: FONT, size: SMALL_SIZE })]
          }),
          new TextRun({ text: " |  ", font: FONT, size: SMALL_SIZE }),
          new ExternalHyperlink({
            link: "http://github.com/coded-by-aditya",
            children: [new TextRun({ text: "GitHub", style: "Hyperlink", font: FONT, size: SMALL_SIZE })]
          }),
        ]
      }),
      ...
      plain("Cloud & Infrastructure:  AWS (Lambda, API Gateway, DynamoDB, S3, Cognito, IAM, SNS)  |  Terraform  |  IaC  |  Serverless", { before: 50, after: 0 }),
      plain("Backend & APIs:  Python  |  REST API design  |  OAuth 2.0 / SSO  |  ETL pipelines  |  SQL  |  Postman"),
      plain("Tools & Delivery:  Git / GitHub  |  GitHub Actions  |  Docker  |  Vue.js  |  JavaScript"),
      ...
      bullet("Diagnosed and fixed production failures in an AI telephony system (Twilio, VAPI, CRM APIs) across live client environments"),
      bullet("Wrote and tuned the prompts behind an AI voice receptionist and built call-handling workflows for after-hours coverage, missed-call capture, and escalation, cutting mishandled calls across client deployments"),
...
Packer.toBuffer(doc).then(buffer => {
  const out = path.join(__dirname, "resume_onepage.docx");
