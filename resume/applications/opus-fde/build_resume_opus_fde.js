...
const doc = new Document({
  ...
  sections: [{
    ...
    children: [
      ...
      plain("Client Delivery:  Requirements scoping  |  Technical workshops & enablement  |  Stakeholder communication"),
...
const outPath = path.join(__dirname, "resume_opus_fde.docx");
